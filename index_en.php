...
<html lang="en">
    <head>
        ...
        <meta name="description" content="The Gigg's is a typical Irish Pub close to the cathedral of Nantes!">
    ...
    <body onload="switchAlcohols()">
        ...
        <main>
            ...
            <div id="onepageEvents">
                ...
                <h3 class="events-sports">Sports events :</h3>
                <ul class="sports">
                    <li>- World Cup</li>
                    <li>- Champions League</li>
                    <li>- The Six Nations Championship</li>
                    <li>- Roland Garros</li>
